...
class Data_Guru(Tk): 
 ...
 # Membuat kursor 
    ...
    def tampilan_gui(self): 
        ...
        self.tree = ttk.Treeview(self, columns=("kode_guru", "nama_guru", "kelompok_guru", "mapel"), show="headings") 
    ...
    def simpan_data(self): 
        ...
        values = (kode_guru, nama_guru, kelompok_guru, mapel) 
...
self.proses_update(data[0])).grid(row=4, column=1, columnspan=2, pady=10) 
    ...
    def proses_update(self, nis_to_update): 
        ...
        values = (kode_guru, nama_guru, kelompok_guru, mapel, nis_to_update) 
